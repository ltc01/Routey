...
const About = () => {
    ...
    return (
        <section id='about' className='py-32 text-white border-y border-gray-700'>
            <div className="text-center">
                <h3 className="text-4xl mb-10 font-bold">About <span className='text-blue-600'>Me</span></h3>
                {/* <p className="text-gray-400 my-3 text-lg">My introduction</p> */}
                <div className='flex md:flex-row mb-32 flex-col-reverse md:gap-6 gap-10 px-16 max-w-6xl mx-auto'>
